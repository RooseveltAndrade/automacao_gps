...
try:
    resposta = requests.get(sistema_url, auth=(usuario, senha), verify=False, timeout=10)  # TODO: Implementar verificação de certificado adequada
    ...
    with open(saida_html, "w", encoding="utf-8") as f:
        f.write(error_html)
    print(f"[ERRO] Erro ao conectar ao iDRAC {idrac_ip}")
