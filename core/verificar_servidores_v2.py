...
class VerificadorServidoresV2:
    ...
    def verificar_regional(self, codigo_regional: str) -> List[Dict]:
        ...
        print(f"🔍 Verificando {regional.get('nome', codigo_regional)} ({len(servidores)} servidores)...")
    ...
    def verificar_todas_regionais(self) -> Dict:
        ...
        print("🚀 Iniciando verificação de todas as regionais...")
        print("=" * 60)
    ...
    def gerar_relatorio_detalhado(self) -> str:
        ...
        if not self.resultados:
            return "❌ Nenhum resultado disponível. Execute a verificação primeiro."
        
        relatorio = []
        relatorio.append("📊 RELATÓRIO DETALHADO DE VERIFICAÇÃO")
        relatorio.append("=" * 60)
        ...
        for codigo_regional, resultados_regional in self.resultados.items():
            ...
            for resultado in resultados_regional:
                status_icon = "🟢" if resultado["status"] == "online" else "🔴" if resultado["status"] == "offline" else "🟡"
                tipo_icon = "🔧" if resultado["tipo"] == "idrac" else "⚙️"
...
<body>
    <div class="container">
        <div class="header">
            <h1>🖥️ Status dos Servidores - Regionais</h1>
...
"""
        ...
        print(f"🌐 Página HTML gerada: {arquivo}")
...
def main():
    ...
    print("🖥️ Verificador de Servidores - Versão 2.0")
    ...
    while True:
        ...
        if opcao == "1":
            ...
            if verificador.resultados:
                ...
                print("❌ Execute uma verificação primeiro")
